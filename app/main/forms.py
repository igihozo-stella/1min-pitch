...
from wtforms import SubmitField, TextAreaField, StringField,SelectField,ValidationError
...
class PitchForm(FlaskForm):
    ...
    category = SelectField('Category', choices=[('Advertisement','Advertisement'),('Project','Project'),('General','General'),('Sale','Sale')], validators=[Required()])
