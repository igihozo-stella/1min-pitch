...
from .forms import UpdateProfile, GeneralForm, GeneralReviewForm, SaleForm, SaleReviewForm, SeductionForm, SeductionReviewForm, MusicForm, MusicReviewForm, ProjectForm, ProjectReviewForm, InterviewForm,PitchForm, InterviewReviewForm, AdvertisementForm, AdvertisementReviewForm
from .. import db
from sqlalchemy import func
from ..models import User,Pitch, Role, Comment, Like,Dislike 
...
def index():
    ...
    '''
    general = Pitch.query.filter_by(category="general").order_by(Pitch.category.desc()).all()
    project = Pitch.query.filter_by(category="project").order_by(Pitch.category.desc()).all()
    advertisement = Pitch.query.filter_by(category="advertisement").order_by(Pitch.category.desc()).all()
    sale = Pitch.query.filter_by(category="sale").order_by(Pitch.category.desc()).all()
...
def profile(uname):
    ...
    get_pitches = Pitch.query.filter_by(id = Pitch.id).all()
